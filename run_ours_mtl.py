...
class RegroupLoraMoECallback(transformers.TrainerCallback):
    ...
    def on_epoch_end(self, args, state, control, model=None, logs=None, **kwargs):
        ...
        # logs may be None, but the latest entry in state.log_history usually contains information
        last_log = {}
...
def main():
    ...
    # Dedicated logger: write to file only, no console output
    ...
    if not regroup_logger.handlers:
        ...
        # Critical: do not add a StreamHandler!

    # After the logging setup in main(), add:
    ...
    if not metrics_logger.handlers:
        ...
        # Do not add a StreamHandler → no console output
    ...
    if 'llama' in model_args.model_name_or_path.lower():
        ...
        tokenizer.padding_side = "left"  # For generation tasks, left padding is safer
    logger.info(
    ...
    # you can use this callback to regroup and log its metrics !!
